...
class ConnectViewController: UIViewController {
    ...
    @IBAction func findParks(_ sender: Any) {
        ...
        let alertvc = UIAlertController.init(title: NSLocalizedString("Please Entre a Postcode", comment: ""), message: nil, preferredStyle: .alert)
    ...
    */
    ...
    func searchLoaction(_ postCode:String, name: String) {
        ...
        if locationArray.count == 0 {
            ProgressHUD().showWithContent(NSLocalizedString("Sorry, No Records", comment: ""))
            return
        }
